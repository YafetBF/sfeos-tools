"""Tests for the crawl-graph CLI command."""
...
class TestCrawlGraph:
    ...
    def test_crawl_graph_detects_true_roots(self):
        ...
        with patch("sfeos_tools.cli.requests.Session") as mock_session_class:
            ...
            mock_session.get.side_effect = [
                catalogs_response,
                children_response_factory("root-catalog"),
                children_response_factory("child-catalog"),
                children_response_factory("grandchild-catalog"),
            ]
